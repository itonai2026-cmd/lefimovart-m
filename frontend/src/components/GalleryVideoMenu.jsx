...
export default function GalleryVideoMenu({ videoId, onFlagged, alignLeft = true }) {
  ...
  const sendReport = async () => {
    ...
    setSending(true);
    try {
      const response = await fetch("/wp/lefimovart/api/videos/report.php", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
        body: JSON.stringify({ id: videoId, flagged_reason: selected }),
      });
