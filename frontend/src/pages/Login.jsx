  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        <p className="text-center text-gray-600 mb-8">AI Image & Video Generation</p>
        ...
        <button
          ...
          className="w-full border border-gray-300 text-gray-700 font-bold py-2 rounded-lg hover:bg-gray-50 flex items-center justify-center gap-2"
        >
